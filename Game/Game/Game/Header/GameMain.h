...
#define GAMESTATE_SPECIALENEMYACTION	0x000400
#define GAMESTATE_ADDENEMY				0x000500
#define GAMESTATE_HPREGAIN				0x000600
#define GAMESTATE_SHOWTURNSTART			0x000700
#define GAMESTATE_PLANNING				0x000800
#define GAMESTATE_SELFACTION			0x000900
#define GAMESTATE_APREGAIN				0x000A00
#define GAMESTATE_ENEMYACTION			0x000B00
#define GAMESTATE_OVER					0x000C00
