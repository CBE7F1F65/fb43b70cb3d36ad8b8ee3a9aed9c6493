...
int BIOInterface::Ini_GetInt(const char *section, const char *name, int def_val, char * inifilename/* =NULL */)
{
	char buf[256];
...
void BIOInterface::Ini_SetFloat(const char *section, const char *name, float value, char * inifilename/* =NULL */)
{
	char buf[256];
...
float BIOInterface::Ini_GetFloat(const char *section, const char *name, float def_val, char * inifilename/* =NULL */)
{
	char buf[256];
...
void BIOInterface::Ini_SetString(const char *section, const char *name, const char *value, char * inifilename/* =NULL */)
{
	char * filename = inifilename;
	if (!filename)
	{
...
DWORD BIOInterface::_IniGetPrivateProfileString(const char * appname, const char * keyname, const char * defval, char * retstr, DWORD size, const char * filename)
{
#ifdef __WIN32
	return GetPrivateProfileStringA(appname, keyname, defval, retstr, size, filename);
#else
...
bool BIOInterface::_IniWritePrivateProfileString(const char * appname, const char * keyname, const char * val, const char * filename)
{
#ifdef __WIN32
	return WritePrivateProfileStringA(appname, keyname, val, filename);
#else
