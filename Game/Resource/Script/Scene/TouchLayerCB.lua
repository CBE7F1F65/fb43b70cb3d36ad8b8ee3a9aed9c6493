	...
	if toptag == ktag_PlaySceneLayer then
		...
		if sublayertag == CCTag_Layer_06 then
			...
			if eventtag == CCTI_Began then
				_PlayScene_CB_Touch_Began(toplayer, toptag, touchlayer, index);
			elseif eventtag == CCTI_Moved then
				_PlayScene_CB_Touch_Moved(toplayer, toptag, touchlayer, index);
			elseif eventtag == CCTI_Ended then
				_PlayScene_CB_Touch_Ended(toplayer, toptag, touchlayer, index);
			else
				_PlayScene_CB_Touch_Canceled(toplayer, toptag, touchlayer, index);
			end
		end
